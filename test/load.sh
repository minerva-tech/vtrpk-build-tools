...
scp -i $HOME/.ssh/teplovisor_id_rsa teplovisor_ccdc_prv_rsz_file		root@192.168.11.111:/usr/bin
#scp -i $HOME/.ssh/teplovisor_id_rsa tvp514x_ccdc_prv_rsz_file		root@192.168.11.111:/usr/bin
