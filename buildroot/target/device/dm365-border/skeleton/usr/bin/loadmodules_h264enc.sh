...
insmod cmemk.ko pools=4x4632,2x59392,2x12672,2x38016,4x518400,2x1000800,3x2097152,1x3932160,1x921600,1x3133440,1x27270144 phys_start=0x85000000 phys_end=0x88000000  allowOverlap=1 phys_start_1=0x00001000 phys_end_1=0x00008000 pools_1=1x28672
insmod edmak.ko
insmod irqk.ko
