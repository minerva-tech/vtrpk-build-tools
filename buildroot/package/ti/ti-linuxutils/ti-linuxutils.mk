...
TI_LINUXUTILS_VERSION:=3.21.00.04
TI_LINUXUTILS_FILE_VERSION:=3_21_00_04
...
define TI_LINUXUTILS_BUILD_CMDS
	for i in $(TI_LINUXUTILS_MODULES) ; do \
		$(MAKE) $(TI_LINUXUTILS_BUILD_MAKE_ARGS) -C $(@D)/packages/ti/sdo/linuxutils/$$i clean release; \
	done
endef
