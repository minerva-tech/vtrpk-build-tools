...
//#define ARM297_DDR270_OSC24 1
//#define ARM432_DDR340_OSC24 1
...
Uint32 DEVICE_init()
{
  ...
  DEVICE_PSCInit();
    ...
    /* we will configure all unconnected pins to gpio mode, output, low level:
       bank0: 2,3,5,9,10,13,15
       bank1: 26,27,29-31
       bank2: 32,38-47
       bank3: 48,49
       bank4: 79
    ...
    GPIO->SETDATA01 = 0x000059C0;
    GPIO->CLRDATA01 = 0xEC00A62C;
    GPIO->DIR01 = 0x13FF0093;

    GPIO->SETDATA23 = 0x00000002; // turn USB 5V on
    GPIO->CLRDATA23 = 0x0003FFC1;
    GPIO->DIR23 = 0xFFFC003C;
...
Uint32 DEVICE_EMIFInit()
{
  ...
  //AEMIF->A1CR = 0x40000004;
  //AEMIF->A1CR = 0x40120094;
  AEMIF->A1CR = 0x0810209C;
  AEMIF->NANDFCR |= 1;
...
Uint32 DEVICE_UART0Init()
{
  ...
  UART0->PWREMU_MGNT = 0xE001;    // Enable TX & RX components
